...
enum ImGuiCol_
{
    ImGuiCol_Scheme,                // Custom scheme/accent color (MUST BE FIRST for loader compatibility)
    ImGuiCol_Scheme2,               // Custom scheme/accent color 2 (MUST BE SECOND for loader compatibility)
    ImGuiCol_Text,
    ...
    ImGuiCol_FrameBg2,              // Secondary frame background color (custom)
    ImGuiCol_TitleBg,
...
struct ImDrawList
{
    ...
    float                   _FringeScale;       // [Internal] anti-alias fringe is scaled by this value, this helps to keep things sharp while Celexing at vertex buffer content

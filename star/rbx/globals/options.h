...
namespace Options
{
	namespace Misc
	{
		...
		inline int MenuKey = 0x2D; // VK_INSERT
	}
	...
	namespace Desync
	{
		...
		inline bool Toggled = false;
		inline uintptr_t NextGenReplicatorOffset = 0x8152668; // Live offset for NextGenReplicatorEnabledWrite4
		inline bool Active = false;
		inline Vectors::Vector3 SpawnPos = {0.0f, 0.0f, 0.0f};
		
		inline bool Visualizer = false;
		inline float VisualizerColor[3] = {1.0f, 0.0f, 0.0f}; // Default Red
	}
}
